...
// const SubmitReport = ({ report, close }: { report: Report; close: Function }) => {
...
//   const submitReport = () => {
//     setLoading(true);
//     ApiEndpoint.put('/reports/send_report', formData)
//       .then((res) => {
//         notifications.show({
//           title: "Send Report",
...
//             onChange={(value: string) => handleSelectChange(value, "organizationLevel")}
...
//             className={`py-3 px-8 rounded-3xl flex items-center justify-center ${loading ? "cursor-not-allowed" : ""} bg-[#0075FF] text-white`}
//           >
//             {loading ? (
