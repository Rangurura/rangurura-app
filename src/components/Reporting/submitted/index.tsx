...
function SubmittedReports() {
  ...
  <div className="w-full flex flex-col">
        ...
        return (
          <div className="h-[3rem] flex items-center justify-between px-3  bg-[#EEF3F9] mt-2">
            ...
            <span className="w-[40px] gap-5 rounded-[20%] flex items-center justify-center">
              <h5 className="text-black text-[80%]"><FaEye/></h5>
              <h5 className="text-green-600 text-[80%]"><FaDownload/></h5>
            </span>
            {/* </div> */}
          </div>
        );
      ...
      <button className=" text-[white] p-2 bg-[#20603D] text-right mt-5 rounded-md" onClick={open}>
        Submit New report
      </button>
      </div>
      <Modal opened={opened} onClose={close} size={"lg"}>
        <SubmitReport close={close} report={{
                  reportName: '',
                  location: '',
                  descriptions: '',
                  organizationLevel: ''
