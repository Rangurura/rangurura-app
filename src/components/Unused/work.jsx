...
const Work=()=>{
    return(
        <section className='bg-[#F4F4F4]  text-black flex flex-col justify-center items-center gap-4 p-6 pb-10'>
            <h3 className='max-[400px]:text-[30px] font-bold text-[40px] text-[#000000]'>How we work</h3>
            <p className='md:text-base text-xs'>Make a difference in your community today. Report your concerns, and let us help you build a better tomorrow with Rangurura</p>
            ...
            {/* <div className='max-[400px]:flex-col flex flex-row justify-center items-start md:gap-16 gap-6 md:px-16 px-0'> */}
                ...
                {/* <div className='flex flex-col md:gap-12 md:mt-32 gap-6'> */}
                    <div className='flex flex-col md:gap-4 gap-1 justify-center items-center'>
                        ...
                        <p className='md:text-base text-xs'>Problem reach to the destination safe and faster through our platform</p>
                    </div>
                    <div className='flex flex-col gap-4 justify-center items-center md:mt-[3.4rem]'>
                        ...
                        <p className='md:text-base text-xs'>We ensure privacy by hiding the person who report his or her concern to the one who was tagged .</p>
                    </div>
                </div>
                ...
                <div className='flex flex-col md:gap-12 md:mt-20 gap-6 md:pt-[8rem]'>
                    <div className='flex flex-col md:gap-4 gap-1 justify-center items-center'>
                        ...
                        <p className='md:text-base text-xs'>Whether it's a pothole, a public service issue, or a community concern, you can easily report it to your local government through our platform.</p>
                    </div>
                    <div className='flex flex-col md:gap-4 gap-1 justify-center items-center'>
                        <Image src={track} alt="" className='md:w-9 w-5'/>
                        <h4 className='font-bold md:text-md text-sm'>Transparent process</h4>
                        <p className='md:text-base text-xs'>We ensure transparency by tracking the progress of your reports, so you can see when and how your issues are being addressed.</p>
                    </div>
                </div>
            </div>
            <div className='flex flex-col justify-center items-center gap-4 mt-5'>
                <Image src={people} alt="" className='md:w-8 w-8 '/>
                <h4 className='font-bold md:text-md text-sm'>Community Engagement</h4>
                <p className='w-full md:text-base text-xs'>Join hands with fellow citizens by reporting your concern to create a stronger community to solve local issues together.</p>
            </div>
        </section>
    )
}
