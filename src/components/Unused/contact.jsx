...
const Contact=()=>{
    const contact=[
        {icon: FaRegEnvelope,name:"mail", head:"Email", text1:"Chat with our friendly team and get updates via Email",text2:"rangurura@gmail.com",type:"email"},
        {icon: LuMessageCircle,name:"chatbubble", head:"Social links", text1:"Follow us on facebook or instagram to receive daily update",text2:"",type:"media"},
        {icon: HiOutlinePhone,name:"call", head:"Call us", text1:"Call our support team",icon:"call",text2:"+25078787878",type:"call"},
    ]
    return(
