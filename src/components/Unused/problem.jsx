    ...
    return(
        <section>
            <div className='bg-white md:h-[70vh] text-black flex flex-col gap-10 items-center p-10 pt-5'>
                ...
                <p className='text-center'>Enhancing Citizen-Leader Communication for a Stronger Society — Dive into solutions that bridge the gap and empower citizens to connect more effectively with their leaders."</p>
