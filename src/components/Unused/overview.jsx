...
import { ChatBubbleOvalLeftEllipsisIcon,UserIcon,ChevronRightIcon } from '@heroicons/react/24/outline'
    ...
    <div>
      <div className='bg-darkblue-default h-700 w-80 block float-right mt-4 mr-12 rounded-xl'>
        ...
        <div className='dist-overview bg-white w-64 ml-7 pb-4 rounded-xl'>
            <div className='title'>
             <h1 className='text-lg font-bold text-black p-4'>District Overview</h1> 
            </div>
