                ...
                <div className='flex flex-col justify-center items-center'>
                    ...
                    <form className='w-full flex flex-col justify-center gap-2'>
                        <div className='flex flex-col gap-1'>
                            <label className='font-semibold text-black'>Hitamo aho ushaka kugeza Ikibazo <span className='text-red-600'>*</span></label>
                            ...
                            {organisationCategory === "Urwego Rw'Ibanze" && (
                                <div  className='flex flex-col gap-1'>
                                    <label className='font-semibold text-black'>Hitamo {organisationCategory} ushaka kugeza Ikibazo <span className='text-red-600'>*</span></label>
                        ...
                        <div className='flex flex-col gap-1'>
                            <label className='font-semibold text-black'>Ikibazo <span className='text-red-600'>*</span></label>
                            <textarea rows={2} placeholder='Ikibazo' className='border-[#C3C3C3] border-2 rounded-md p-2' style={{resize:"none"}}></textarea>
                        </div>
                        <div className='w-full flex flex-col gap-1'>
                            <label className='font-semibold text-black'>Proof</label>
                            <div className='p-9 rounded-md border-2 border-[#C3C3C3] w-full flex items-center justify-center'>
