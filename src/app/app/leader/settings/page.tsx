            ...
            <div className="w-[70%] h-[50%] bg-white rounded-[10px]"> 
                ...
                <div className="w-full h-4/5 px-4 flex justify-start gap-4 pl-3 py-3">
                    <div className="w-[20%] flex flex-col">
                        <button type="button" className={`py-2 px-4 rounded ${activated == "account" ? "bg-[#ccc]" : ""}  my-1`} onClick={()=> setActivated("account")}>Account</button>
                        <button type="button" className={`py-2 px-4 rounded ${activated == "theme" ? "bg-[#ccc]" : ""}  my-1`} onClick={()=> setActivated("theme")}>Theme</button>
                        <button type="button" className={`py-2 px-4 rounded ${activated == "language" ? "bg-[#ccc]" : ""}  my-1`} onClick={()=> setActivated("language")}>Language</button>
                    </div>
                    
                    {activated == "account" ? <SettingsProfile/> : activated == "theme" ? <SettingsTheme/> : <SettingsLanguage/>}
                </div>
            </div>
        </div>
    )
