  ...
  return (
    <div className="w-full md:h-[90%] mt-4">
      <div className="w-full flex items-center justify-between">
        ...
        <button type="button" onClick={open} className="bg-[#20603D] w-[10rem] px-3 py-3 rounded-lg flex items-center justify-center text-white font-extrabold">
          New Leader
        </button>
      </div>
